...
import HelperPackages.PrinterOperations.ReportPrinter;
...
public class CampApp {
    ...
    public static final ReportPrinter reportPrinter = new ReportPrinter();
                                                ...
                                                while (!filterOption.equals("4")) {
                                                    switch (filterOption) {
                                                        case "1": {
                                                            ...
                                                            reportPrinter.generateCustomReport(desiredCamp, users,1);

                                                            break;
                                                        }
                                                        case "2": {
                                                            System.out.println("Generating Custom Report for Camp " + desiredCamp.getStaticDetails().getCampID());
                                                            reportPrinter.generateCustomReport(desiredCamp, users,2);
                                                            break;
                                                        }
                                                        case "3": {
                                                            System.out.println("Generating Custom Report for Camp " + desiredCamp.getStaticDetails().getCampID());
                                                            reportPrinter.generateCustomReport(desiredCamp, users,3);
                                                            break;
                                                        }
                                                        default: {
                                                            System.out.println("Invalid option");
